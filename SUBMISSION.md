...
| **Source code** (public GitHub) | ⬜ *you upload* | this repo — make a public GitHub repo and upload |
| **Documentation** (setup + `about` flow) | ✅ | [README](README.md) (setup) + [ABOUT.md](ABOUT.md) (flow) |
| **Demo video** (3–5 min) | ⬜ *you record* | script in [DEMO.md](DEMO.md) |
...
- **Technical (30%)** — typed TS on Canon's pipeline, 39 tests (core math 100%), zod-validated I/O, `.canon/execution/` logging, clean module boundaries.
